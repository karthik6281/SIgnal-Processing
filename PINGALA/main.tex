...
\begin{lstlisting}
	https://github.com/Pranavb060504/Signal-Processing/tree/main/pingala/codes/1.py
\end{lstlisting}
...
Run the below python code 
\begin{lstlisting}
	https://github.com/Pranavb060504/Signal-Processing/tree/main/pingala/codes/2.py
\end{lstlisting}
Use the following command in the terminal to run the code
\begin{lstlisting}
	python3 2.py
